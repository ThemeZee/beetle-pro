...
( function( wp, $ ) {
	 ...
	 */
	wp.customize.controlConstructor.beetle_pro_custom_font = wp.customize.Control.extend({
		/**
	 ...
	 */
	wp.customize.controlConstructor.beetle_pro_custom_font_list = wp.customize.Control.extend({
		/**
		 * This method is called when the control is ready to run.
		 * Do all of your setup and event binding here.
		 */
