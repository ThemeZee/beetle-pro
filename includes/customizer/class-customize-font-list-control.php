...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class Beetle_Pro_Customize_Font_List_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'beetle_pro_custom_font_list';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'update' => __( 'Update Fonts', 'beetle-pro' ),
			);
		...
		public function render_content() {
			...
			$default = json_encode( Beetle_Pro_Custom_Font_Lists::get_fonts( 'default' ) );
			$favorite = json_encode( Beetle_Pro_Custom_Font_Lists::get_fonts( 'favorite' ) );
			$popular = json_encode( Beetle_Pro_Custom_Font_Lists::get_fonts( 'popular' ) );
			$all = json_encode( Beetle_Pro_Custom_Font_Lists::get_fonts( 'all' ) );
