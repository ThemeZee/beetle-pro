 ...
 */
class Beetle_Pro_Custom_Font_Lists {
	...
	public static function get_fonts( $type ) {
		...
		switch ( $type ) :
			...
			case 'all':
				$fonts = Beetle_Pro_Custom_Font_Lists::all_google_fonts();
			break;

			case 'popular':
				$fonts = Beetle_Pro_Custom_Font_Lists::popular_google_fonts();
			break;

			case 'default':
				$fonts = Beetle_Pro_Custom_Font_Lists::default_browser_fonts();
			break;

			default:
				$fonts = Beetle_Pro_Custom_Font_Lists::favorite_google_fonts();
			break;
