...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Beetle_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'beetle-pro' ),
				'next'     => esc_html__( 'Next Font', 'beetle-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'beetle-pro' ),
			);

			// Set Fonts.
			$this->local_fonts = Beetle_Pro_Custom_Fonts::get_local_fonts();
			$this->google_fonts = Beetle_Pro_Custom_Fonts::get_google_fonts();
				...
				<label>
					...
					<div class="customize-font-select-control">
						<select <?php $this->link(); ?>>
							<optgroup label="<?php esc_html_e( 'Local Fonts', 'beetle-pro' ); ?>">
								<?php
							...
							<optgroup label="<?php esc_html_e( 'Google Web Fonts', 'beetle-pro' ); ?>">
	  							<?php
