...
class Beetle_Pro_Magazine_Posts_Single_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Magazine (Single Post)', 'beetle-pro' ), // Name.
			array(
				'classname' => 'beetle-magazine-single-widget',
				'description' => esc_html__( 'Displays a single post from a selected category.', 'beetle-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Single Post)', 'beetle-pro' ),
			'category' => 0,
		);
	...
	function render( $settings ) {
		...
		// Get cached post id.
		$post_id = beetle_get_magazine_post_ids( $this->id, $settings['category'], 1 );
