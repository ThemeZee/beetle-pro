...
class Beetle_Pro_Magazine_Posts_Single_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget
		parent::__construct(
			'beetle-magazine-posts-single', // ID
	...
	function widget( $args, $instance ) {
		...
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'widget_beetle_magazine_posts_single', 'widget' );
		}
		if ( ! is_array( $cache ) ) {
			$cache = array();
		}
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'widget_beetle_magazine_posts_single', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'meta_category' ); ?>">
				...
				<?php esc_html_e( 'Display post category', 'beetle-pro' ); ?>
			</label>
		</p>
...
<?php
	...
	public function delete_widget_cache() {
		...
		wp_cache_delete( 'widget_beetle_magazine_posts_single', 'widget' );
...
// Register Widget
add_action( 'widgets_init', 'beetle_pro_register_magazine_posts_single_widget' );

function beetle_pro_register_magazine_posts_single_widget() {
