 ...
 */
class Beetle_Pro_Magazine_Vertical_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'beetle-magazine-vertical-box', // ID.
			esc_html__( 'Magazine (Vertical Box)', 'beetle' ), // Name.
			array(
				'classname' => 'beetle-magazine-vertical-box-widget',
				'description' => esc_html__( 'Displays your posts from a selected category in a vertical box. Please use this widget ONLY in the Magazine Homepage widget area.', 'beetle' ),
	...
	function render( $settings ) {
		...
		// Get cached post ids.
		$post_ids = beetle_get_magazine_post_ids( $this->id, $settings['category'], 5 );
 ...
 * Register Widget
 */
function beetle_register_magazine_posts_vertical_box_widget() {

	register_widget( 'Beetle_Pro_Magazine_Vertical_Box_Widget' );

}
add_action( 'widgets_init', 'beetle_register_magazine_posts_vertical_box_widget' );
