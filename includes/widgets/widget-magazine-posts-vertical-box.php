...
class Beetle_Pro_Magazine_Vertical_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Magazine (Vertical Box)', 'beetle-pro' ), // Name.
			array(
				'classname' => 'beetle-magazine-vertical-box-widget',
				'description' => esc_html__( 'Displays your posts from a selected category in a vertical box. Please use this widget ONLY in the Magazine Homepage widget area.', 'beetle-pro' ),
	...
	function widget( $args, $instance ) {
		...
		if ( ! function_exists( 'beetle_get_magazine_post_ids' ) ) {
