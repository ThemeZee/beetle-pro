...
class Beetle_Pro_Magazine_Posts_Boxed_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			sprintf( esc_html__( 'Magazine Posts: Boxed (%s)', 'beetle-pro' ), 'Beetle Pro' ), // Name
			array( 
				'classname' => 'beetle_magazine_posts_boxed', 
				'description' => esc_html__( 'Displays your posts from a selected category in a boxed layout. Please use this widget ONLY in the Magazine Homepage widget area.', 'beetle-pro' ) 
			) // Args
		);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('layout'); ?>"><?php esc_html_e( 'Post Layout:', 'beetle-pro' ); ?></label><br/>
			<select id="<?php echo $this->get_field_id('layout'); ?>" name="<?php echo $this->get_field_name('layout'); ?>">
				<option <?php selected( $settings['layout'], 'horizontal' ); ?> value="horizontal" ><?php esc_html_e( 'Horizontal Arrangement', 'beetle-pro' ); ?></option>
				<option <?php selected( $settings['layout'], 'vertical' ); ?> value="vertical" ><?php esc_html_e( 'Vertical Arrangement', 'beetle-pro' ); ?></option>
			</select>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'meta_date' ); ?>">
				...
				<?php esc_html_e( 'Display post date', 'beetle-pro' ); ?>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'meta_author' ); ?>">
				...
				<?php esc_html_e( 'Display post author', 'beetle-pro' ); ?>
			</label>
		</p>
...
// Register Widget
add_action( 'widgets_init', 'beetle_pro_register_magazine_posts_boxed_widget' );

function beetle_pro_register_magazine_posts_boxed_widget() {
