...
class Beetle_Pro_Magazine_Posts_List_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			sprintf( esc_html__( 'Magazine Posts: List (%s)', 'beetle-pro' ), 'Beetle Pro' ), // Name.
			array(
				'classname' => 'beetle_magazine_posts_list',
	...
	function widget( $args, $instance ) {
		...
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'widget_beetle_magazine_posts_list', 'widget' );
		}
		if ( ! is_array( $cache ) ) {
			$cache = array();
		}
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'widget_beetle_magazine_posts_list', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	...
	public function delete_widget_cache() {
		...
		wp_cache_delete( 'widget_beetle_magazine_posts_list', 'widget' );
